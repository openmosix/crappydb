...
public class TcpTransportSession extends TransportSession {

	public TcpTransportSession(SelectionKey selection) {
		super();
		commandReader = new ServerCommandReader(new TcpBufferReader(selection));
		commandWriter = new TcpCommandWriter(selection);
