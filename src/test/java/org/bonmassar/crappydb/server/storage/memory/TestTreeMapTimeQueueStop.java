...
public class TestTreeMapTimeQueueStop  extends TestCase {
	...
	public void testKillItemDoesNotExists(){
		...
		assertTrue(queue.queue.containsKey(1252101096L));
		assertTrue(queue.queue.containsKey(1252101097L));
		assertTrue(queue.queue.containsKey(1252101098L));
		assertEquals(2, queue.queue.get(1252101098L).size());
		assertTrue(queue.queue.get(1252101098L).contains(key1));
		assertTrue(queue.queue.get(1252101098L).contains(key1));
	}
	...
	public void testKillItem1(){
		...
		assertTrue(queue.queue.containsKey(1252101097L));
		assertTrue(queue.queue.containsKey(1252101098L));
		assertEquals(1, queue.queue.get(1252101098L).size());
		assertEquals(key2, queue.queue.get(1252101098L).get(0));
	}
	...
	public void testKillItem2(){
		...
		assertTrue(queue.queue.containsKey(1252101098L));
		assertEquals(1, queue.queue.get(1252101098L).size());
		assertEquals(key1, queue.queue.get(1252101098L).get(0));
	}
