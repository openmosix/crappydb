...
public class TestReferenceBean extends TestCase {
	...
	public void setUp() {
		...
		bean = new ReferenceBean(k, 89L);
	}
	
	@Test
	public void testShouldThrowNPE() {
		try {
			new ReferenceBean(null, 89L);
	...
	public void testCompareLess() {
		ReferenceBean bean2 = new ReferenceBean(k, 88L);
		assertTrue((bean.compareTo(bean2))>0);
	}
	
	@Test
	public void testCompareMore() {
		ReferenceBean bean2 = new ReferenceBean(k, 90L);
		assertTrue((bean.compareTo(bean2))<0);
	}
	...
	public void testCompareEqualsNumLessKey() {
		...
		ReferenceBean bean2 = new ReferenceBean(k2, 89L);
		assertTrue((bean.compareTo(bean2))>0);
	}
