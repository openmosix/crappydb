...
public class TestGetsServerCommand extends TestCase {
	...
	public void testToStringMultpleKeys() throws ErrorException {
		...
		assertEquals("{Gets key1=key1 key2=key2 key3=key3 key4=key4 }", command.toString());
	}
	
	@Test
	public void testToStringOneKey() throws ErrorException {
		command.parseCommandParams("key1");
		assertEquals("{Gets key1=key1 }", command.toString());
	}
	...
	@Test
	public void testGetOneKeySomeData() throws ErrorException, StorageException {
		...
		command.execCommand();
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio 12 17 1994721760316\r\n");
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testGetMultipleKeysSomeData() throws ErrorException, StorageException {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testGetMultipleKeysMultipleData() throws ErrorException, StorageException {
		command.parseCommandParams("terminenzio terminenzio2");
		...
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio 12 17 1994721760316\r\n");
		verify(output, times(1)).writeToOutstanding("this is some data".getBytes());
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio2 80 18 1649916820626\r\n");
	...
	public void testGetMultipleKeysWithCasNullData() throws ErrorException, StorageException {
		...
		command.execCommand();
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio 12 0 506819\r\n");
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio2 80 0 508927\r\n");
		verify(output, times(2)).writeToOutstanding("\r\n");
		verify(output, times(1)).writeToOutstanding("END\r\n");
	}
	...
	public void testGetMultipleKeysWithCasNoData() throws ErrorException, StorageException {
		...
		command.execCommand();
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio 12 0 507780\r\n");
		verify(output, times(1)).writeToOutstanding("VALUE terminenzio2 80 0 509888\r\n");
		verify(output, times(2)).writeToOutstanding("\r\n");
		verify(output, times(1)).writeToOutstanding("END\r\n");
	}
