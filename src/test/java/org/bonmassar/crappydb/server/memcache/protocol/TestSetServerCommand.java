...
public class TestSetServerCommand extends TestCase {

	private SetServerCommand command;
	...
	@Test 
	public void testSetRainbow() throws ErrorException, StorageException {
	...
	@Test 
	public void testSetExceptionOnStorage() throws ErrorException, StorageException {
		command.parseCommandParams("terminenzio 12 48 50 noreply\r\n");
		command.addPayloadContentPart("012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789".getBytes());
		assertEquals(50, command.payloadCursor);
